...
- [技术栈](#技术栈)
- [核心改进](#核心改进)
  - [MyBatis Plus 字段自动填充](#1-mybatis-plus-字段自动填充)
  - [密码加密安全改进](#2-密码加密安全改进)
  - [SpringDoc OpenAPI](#3-swagger-官网新版本-springdoc-openapi)
  - [Swagger 消息转换器](#4-处理-swagger-字符串处理问题)
  - [雪花算法 ID 精度](#5-mybatis-plus-雪花算法-id-精度处理)
  - [MapStruct 转换](#6-mapstruct-转换代替默认-util-或-hutool)
  - [FastJson2](#7-使用-fastjson2-代替-fastjson)
  - [Spring Cache 序列化](#8-实现-springcache-的序列化保存对象类别)
- [项目结构](#项目结构)
- [快速开始](#快速开始)
  - [环境要求](#环境要求)
  - [运行步骤](#运行步骤)
- [CI/CD](#cicd-持续集成与部署)
  - [Jenkins Pipeline](#jenkins-pipeline-流程)
