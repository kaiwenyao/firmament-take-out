...
public class OrderController {
     ...
     * Pay for order.
     *
     * @param ordersPaymentDto The order payment data transfer object containing order number and payment method.
     * @return The operation result, returns success message on success.
     */
    @PutMapping("/payment")
     ...
     * @param status   The order status, 1 pending payment, 2 pending acceptance, 3 accepted,
